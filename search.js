...
const { getLabelsForIntent }      = require("./labels");
const { buildCandidates, rankCandidates } = require("./rank");
const { generateSpecializations } = require("./present");
...
exports.handler = async (event) => {
  ...
  if (needsClarification) {
    const { clarificationQuestion: cq, clarifyOptions } = require("./intent").INTENT_MAP
    ...
    return {
      ...
      body: JSON.stringify({
        ...
        clarify_options:        clarifyOptions || null,
