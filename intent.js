...
const INTENT_MAP = [
  ...
  { intent: "Window Cleaning",          triggers: ["window clean", "clean my window", "wash my window", "window wash", "windows cleaned", "windows washed", "clean windows", "wash windows", "window cleaning", "dirty windows", "my windows", "window washer", "window", "windows"] },
  ...
  { intent: "Legal Services",           triggers: ["lawyer", "attorney", "legal"], clarify: "What type of legal help do you need?", clarifyOptions: [
    { label: "Probate / Estate",   intent: "Probate / Estate Planning" },
    { label: "Family Law",         intent: "Family Law" },
    { label: "Personal Injury",    intent: "Personal Injury" },
    { label: "Real Estate Law",    intent: "Real Estate Law" },
    { label: "Business Law",       intent: "Business Law" },
    { label: "Educational Law",    intent: "Educational Law" },
  ]},
  ...
  { intent: "Insurance",                triggers: ["insurance"], clarify: "What type of insurance are you looking for?", clarifyOptions: [
    { label: "Health Insurance",   intent: "Health Insurance" },
    { label: "Auto Insurance",     intent: "Auto Insurance" },
    { label: "Life Insurance",     intent: "Life Insurance" },
    { label: "Pet Insurance",      intent: "Pet Insurance" },
    { label: "Home / Property",    intent: "Home / Property Insurance" },
    { label: "Business Insurance", intent: "Business Insurance" },
  ]},
  ...
  // Auto
  { intent: "Auto Repair",              triggers: ["mechanic", "auto repair", "car repair", "vehicle repair", "brake", "oil change", "tire", "alignment", "suspension", "diesel", "transmission", "engine", "car won't start", "car wont start", "car not starting", "check engine", "car trouble", "fix my car", "car broke", "vehicle broke"] },
...
function classifyIntent(query) {
  ...
  for (const entry of INTENT_MAP) {
    const matched = entry.triggers.some(t => {
      ...
      // Single-word trigger: match whole word only
      if (!tl.includes(' ')) {
        return q === tl || q.startsWith(tl + ' ') || q.endsWith(' ' + tl) || q.includes(' ' + tl + ' ');
      }
      return q.includes(tl);
    });
    if (!matched) continue;
